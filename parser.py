...
text = nltk.word_tokenize(
    "I want to add a hobby for reading every 2 days for 5 minutes")
text1 = nltk.word_tokenize(
    "I want to remove a hobby")
text2 = nltk.word_tokenize(
...
for pos in text:
    if pos[1].startswith("VB"):
        if pos[0].contains("want"):
    elif pos[1].startswith():
